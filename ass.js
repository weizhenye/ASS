...
// ASS.prototype._animate = {
//   move: function(o) {
//     if (o.ct > o.e.End) {
//       o.alive = false;
//       return;
//     }
//     var x1 = o.e.animation.move[0],
//         y1 = o.e.animation.move[1],
//         x2 = o.e.animation.move[2],
//         y2 = o.e.animation.move[3],
//         t1 = o.e.animation.move[4],
//         t2 = o.e.animation.move[5],
//         t = (o.ct - o.e.Start) * 1000,
//         nx,
//         ny;
//     if (t < t1) {
//       nx = x1;
...
//       ny = y2;
//     } else {
//       nx = (t - t1) / (t2 - t1) * (x2 - x1) + x1;
//       ny = (t - t1) / (t2 - t1) * (y2 - y1) + y1;
//     }
//     if (o.e.Alignment % 3 == 1) o.e.style.left = o.s * nx + 'px';
//     if (o.e.Alignment % 3 == 2) o.e.style.left = o.s * nx - o.e.clientWidth / 2 + 'px';
//     if (o.e.Alignment % 3 == 0) o.e.style.left = o.s * nx - o.e.clientWidth + 'px';
//     if (o.e.Alignment <= 3) o.e.style.top = o.s * ny - e.clientHeight + 'px';
//     if (o.e.Alignment >= 4 && o.e.Alignment <= 6) o.e.style.top = o.s * ny - o.e.clientHeight / 2 + 'px';
//     if (o.e.Alignment >= 7) o.e.style.top = o.s * ny + 'px';
//   },
//   fad: function(o) {
//     if (o.ct > o.e.End) {
//       o.alive = false;
//       return;
//     }
//     var t1 = o.e.animation.fad[0] * 1,
//         t2 = o.e.animation.fad[1] * 1 + t1,
//         t = (o.ct - o.e.Start) * 1000,
//         op;
//     if (t < 0 || t > t2) return;
//     if (t < t1) {
...
//       return;
//     }
//     var a1 = o.e.animation.fad[0],
//         a2 = o.e.animation.fad[1],
//         a3 = o.e.animation.fad[2],
//         t1 = o.e.animation.fad[3],
//         t2 = o.e.animation.fad[4],
//         t3 = o.e.animation.fad[5],
//         t4 = o.e.animation.fad[6],
//         t = (o.ct - o.e.Start) * 1000,
//         op;
//     if (t < t1) {
//       op = 1 - a1 / 255;
//     } else if (t < t2) {
//       op = 1 - ((t - t1) / (t2 - t1) * (a2 - a1) + a1) / 255;
//     } else if (t < t3) {
//       op = 1 - a2 / 255;
//     } else if (t < t4) {
//       op = 1 - ((t - t3) / (t4 - t3) * (a3 - a2) + a2) / 255;
//     } else {
//       op = 1 - a3 / 255;
//     }
//     o.e.style.opacity = op;
